...
public class MulticastDnsRequestor {
     ...
     * @throws IOException
     */
    public LinkedList<String> query(String host) throws IOException {
            ...
            while (answers.size() == 0) {
                ...
                try {
                    ...
                    try {
                        ...
                        Log.d(TAG, "Message contain " + responseMsg.getAnswers().size() + " answers and " + responseMsg.getQuestions().size() + "questions");
                        for (DNSAnswer a : responseMsg.getAnswers()) {
                            Log.d(TAG, "Decoding answer..");
                    ...
                    Log.v(TAG, "Timeout..");
                    Log.v(TAG, "Found: " + answers.size() + " devices");
                    int i;
                    for(i=0; i<answers.size(); i++){
                        Log.v(TAG, i + ". " + answers.get(i));
                    }
